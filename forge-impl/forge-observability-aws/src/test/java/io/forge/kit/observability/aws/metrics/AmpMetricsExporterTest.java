...
class AmpMetricsExporterTest
{
    ...
    void pushMetrics_logsSnappySizeAndResponseBodyOnFailure()
    {
        ...
        final java.util.logging.Logger julLogger = java.util.logging.Logger.getLogger("io.forge.kit.observability.aws.metrics.AmpMetricsExporter");
        ...
        assertEquals(1.0, metrics.get("forge.observability.amp.push.failure").counter().count());
