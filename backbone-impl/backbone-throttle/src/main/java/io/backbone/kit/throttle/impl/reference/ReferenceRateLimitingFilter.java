package io.backbone.kit.throttle.impl.reference;

import io.backbone.kit.throttle.api.infrastructure.RateLimitStatus;
import io.backbone.kit.throttle.api.infrastructure.RateLimiter;
import io.backbone.kit.throttle.impl.key.strategy.HttpHeaderRateLimitKeyStrategy;
 ...
 * {@code backbone.rate-limit.reference.enabled} property.</p>
 *
...
@ApplicationScoped
@IfBuildProperty(
    name = "backbone.rate-limit.reference.enabled", stringValue = "true"
)
