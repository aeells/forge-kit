package io.backbone.kit.throttle.impl.infrastructure.health;

import io.backbone.kit.throttle.impl.infrastructure.Bucket4jRateLimiterProducer;
 ...
 *
 * <p>Registered via {@link RateLimitHealthCheckProducer} when backbone-throttle is on the classpath.</p>
 */
