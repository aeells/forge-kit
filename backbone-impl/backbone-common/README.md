...
`backbone-common` contains **shared utilities and primitives** used across Backbone Kit modules.
...
`backbone-common` provides utilities that are automatically wired in when included as a dependency. No additional configuration is required.
...
See: [examples/backbone-common](../../examples/backbone-common)
