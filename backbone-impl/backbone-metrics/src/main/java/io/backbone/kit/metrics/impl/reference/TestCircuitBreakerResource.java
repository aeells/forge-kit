package io.backbone.kit.metrics.impl.reference;
...
public final class TestCircuitBreakerResource
{
    ...
    @CircuitBreakerName("io.backbone.metrics.presentation.rest.TestCircuitBreakerResource#triggerCircuitBreaker")
